...
```bash
UV_CACHE_DIR=/tmp/double-pendulum-uv-cache uv run pytest development/chaos_content/experiments/004_finite_time_exponential_growth/test_finite_time_exponential_growth.py -q
UV_CACHE_DIR=/tmp/double-pendulum-uv-cache uv run python development/chaos_content/experiments/004_finite_time_exponential_growth/finite_time_exponential_growth.py --self-check --output-dir development/chaos_content/outputs/finite_time_exponential_growth/baseline --plots
```
