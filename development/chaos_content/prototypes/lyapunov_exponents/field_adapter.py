...
from .fortran_dop853 import run_renormalized_tangent_compiled_fortran
from .hybrid import (
...
def periodic_lyapunov_field_definition(
    ...
    return FieldDefinition(
        ...
        software_provenance={
            "prototype": "scalar_field_generation",
    ...
    for theta2_index, theta1_index in selected:
        ...
        if stored_route == HYBRID_FAST_EVALUATOR:
            fast_comparison = compare_results(
                oracle,
                run_renormalized_tangent_compiled_fortran(cell_spec),
            )
        accepted = bool(
