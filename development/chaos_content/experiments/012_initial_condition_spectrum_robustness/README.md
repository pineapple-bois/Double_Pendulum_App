...
PYTHONDONTWRITEBYTECODE=1 .venv/bin/python \
  development/chaos_content/experiments/012_initial_condition_spectrum_robustness/initial_condition_spectrum_robustness.py \
  --self-check \
...
PYTHONDONTWRITEBYTECODE=1 .venv/bin/python -m pytest -q \
  ...
  development/chaos_content/experiments/010_independent_shadow_640s_compatibility \
  development/chaos_content/experiments/011_hamiltonian_canonical_spectrum_crosscheck \
  development/chaos_content/experiments/012_initial_condition_spectrum_robustness
```
