...
```bash
uv run pytest development/chaos_content/experiments/003_lyapunov_distance_contract/test_lyapunov_distance_investigation.py
```

Run the deterministic numerical self-check:

```bash
uv run python development/chaos_content/experiments/003_lyapunov_distance_contract/lyapunov_distance_investigation.py --self-check
```
