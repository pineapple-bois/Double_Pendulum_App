...
from app.pages.equations import layout as equations_layout
...
PAGE_LAYOUTS = {
    ...
    EQUATIONS_PAGE.path: equations_layout,
    LAGRANGIAN_PAGE.path: equations_layout,
    HAMILTONIAN_PAGE.path: equations_layout,
