...
// The below version of the script ONLY scrolls if above the target content
...
//                 const target = document.getElementById('scroll-target');
//                 if (target) {
//                     // Check if the current scroll position is above the target
//                     const targetPosition = target.getBoundingClientRect().top + window.pageYOffset;
//                     const currentPosition = window.pageYOffset;
//
//                     if (currentPosition < targetPosition) {
//                         // Scroll to the specific section if above the target
//                         target.scrollIntoView({ behavior: 'smooth' });
//                     }
//                 } else {
//                     console.error("Scroll target not found!");
