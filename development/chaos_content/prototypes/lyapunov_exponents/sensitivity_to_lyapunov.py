...
Run from the repository root:
    ...
    uv run python development/chaos_content/prototypes/lyapunov_exponents/\
...
written beneath the strand-local ``outputs/`` directory.
"""
...
from reference import SensitivityToLyapunovResult, run_sensitivity_to_lyapunov
...
def save_figure(result: SensitivityToLyapunovResult) -> Path:
    """Save the figure to the strand-local untracked output directory."""
