...
from compiled import evaluate_renormalized_tangent_compiled
from compiled_equivalence import VALIDATION_ANGLE_PAIRS_DEGREES, validation_spec
from fortran_dop853 import evaluate_renormalized_tangent_compiled_fortran
...
from reference import EulerLagrangeState, RenormalizedTangentSpec
...
def test_unrelated_execution_errors_do_not_trigger_fallback(
    ...
    error = ScalarEvaluation(
        ...
        diagnostics=None,
        elapsed_seconds=0.0,
        evaluator=hybrid_module.COMPILED_FORTRAN_EVALUATOR,
