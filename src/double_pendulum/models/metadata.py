...
class SolverMetadata:
    ...
    @classmethod
    def from_solve_ivp(cls, integrator, ode_result, requested_time, solution, solver_kwargs):
    ...
    @classmethod
    def from_odeint(cls, integrator, requested_time, solution, solver_kwargs):
        return cls(
            integrator=_integrator_name(integrator),
            success=None,
            status=None,
