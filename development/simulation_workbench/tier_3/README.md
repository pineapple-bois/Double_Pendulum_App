...
- `tier_3d_interaction_contract/` - active; state, event, stale-output, run ID, and selected-frame contract.
...
Start with `TIER_3_ROADMAP.md`, then the Tier 3C.2 synced-inspection note, and
the active Tier 3D directory.
